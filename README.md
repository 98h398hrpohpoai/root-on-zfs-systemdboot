...
To make your zpool bootable you have two options. Both require you to mount the new boot partition to /boot/efi (which should already be done if just installed via bootctl above). 
